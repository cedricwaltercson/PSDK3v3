...
"x86_64-msys-thread-multi-3.0.6(0.33853)" or
	die "Errno architecture (x86_64-msys-thread-multi-3.0.6(0.33853)) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
